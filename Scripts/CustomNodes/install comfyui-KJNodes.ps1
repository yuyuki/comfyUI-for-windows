...
Write-Host "=== Installing: ComfyUI-KJNodes ===" -ForegroundColor Cyan
...
# ------------------------
Write-Host "`n=== Installing ComfyUI-KJNodes ===" -ForegroundColor Yellow
$RepoDir = "$CustomNodesDir\ComfyUI-KJNodes"
$RepoUrl = "https://github.com/kijai/ComfyUI-KJNodes.git"

if (Test-Path $RepoDir) {
    try {
        Write-Host "Updating existing ComfyUI-KJNodes repo..." -ForegroundColor Yellow
        git -C "$RepoDir" pull --ff-only
    }
    catch {
        Write-Warning "Update failed. Re-cloning ComfyUI-KJNodes..."
